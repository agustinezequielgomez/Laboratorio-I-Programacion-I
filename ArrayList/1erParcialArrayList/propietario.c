...
void menu()
{
    ...
    if(listaPropietarios!=NULL)
    {
        ...
        do
        {
            ...
            printf("\n11- Mostrar propietarios que tienen coches marca AUDI estacionados");
            printf("\n12- Mostrar automoviles ingresados con sus propietarios");
            printf("\n13- Salir");
            ...
            case 9:
                ...
                break;
            case 10:
                mostrarPropietarioConSusCoches(listaPropietarios,automoviles);
                system("pause");
                break;
            case 11:
                mostrarPropietariosQueTenganAudi(automoviles,listaPropietarios);
                break;
            case 12:
                mostrarListadoDeAutosPorPatente(automoviles,listaPropietarios);
                break;
            case 13:
                continuar='n';
                break;
...
int compare_propietarios(ArrayList* this, void* id)
{
    int retorno=-1;
    ePropietario* aux;
    int i;
